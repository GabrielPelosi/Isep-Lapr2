...
public class Data implements Serializable {
    ...
    public Data(String data) {
        try {
            ...
            if (info.length == 3) {
                ano = Integer.parseInt(info[0].trim());
                mes = Integer.parseInt(info[1].trim());
                dia = Integer.parseInt(info[2].trim());
            }
        } catch (Exception ex) {
    ...
    public boolean same(Data outraData) {
        return toString().equals(outraData.toString());
    }
    ...
    /**
     * Devolve a diferença em número de diasentre a data e a data recebida por parâmetro com ano, mês e dia
     *
